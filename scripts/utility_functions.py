...
class Logger():
    ...
    In BOPrO the log is always created. The stdout can be switch off in interactive mode for example.
    It works overloading sys.stdout.
    '''

    def __init__(self, log_file="bopro_logfile.log"):
...
def validate_json(parameters_file):
    """
    Validate a json file using BOPrO's schema.
